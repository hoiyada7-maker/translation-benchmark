...
| **gemma4-e4b** | `gemma4:e4b` (`gemma4:latest`와 동일 스펙 태그) | gemma4 / 8.0B / Q4_K_M | Ollama, GPU, 블록단위×6, 전/후 문맥 프롬프트 | **7.2분** | `gemma4:latest`와 별도로 실측 — 시간·번역문 모두 사실상 동일(동일 가중치의 다른 태그임을 재확인) |
